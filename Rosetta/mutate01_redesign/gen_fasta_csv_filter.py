...
score_df = df
score_df = score_df.iloc[0:15,:]
pstat_df = df.sort_values(by=['pstat'],ascending=[False])
pstat_df = pstat_df.iloc[0:15,:]
...
print("Created a separate folder for lowest 15 total scores located in \"total-score\".")
filter_score(pstat_filter,"pstat-score")
print("Created a separate folder for top 15 packing scores located in \"pstat-score\".")
